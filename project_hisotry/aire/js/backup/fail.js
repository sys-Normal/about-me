...
$(function(){
    ...
    var pageTop = function(){
        ...
        value[4] = $wrap.find("#news").offset().top;
        value[5] = $wrap.find("#contact").offset().top;
    };
    ...
    $(window).on("scroll", function(){
        ...
        if(scrollTop>$("#about").offset().top - 71 && scrollTop<$("#service").offset().top - 69) {
            ...
            nowIdx=2;
            idxMov();
        }else if(scrollTop>$("#news").offset().top -71 && scrollTop<$("#contact").offset().top - 69){
            nowIdx=3;
            idxMov();
...
$(function(){
    ...
    $(window).on("scroll", function(){
        ...
        // 스크롤 바텀값
        var $point = $("body").height() - $(window).height() - $(window).scrollTop();
